...
def services(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if farmer_id:
                service_request.farmer_id = farmer_id
...
#         }
#     )
def machinery_details(request):

    return render(
        request,
        'services/machinery_details.html'
    )


def farmer_support_details(request):

    return render(
        request,
        'services/farmer_support_details.html'
    )
